...
void protobuf_AddDesc_image_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013image.proto\"t\n\005image\022\022\n\nimage_data\030\001 \003"
    "(\005\022\r\n\005width\030\002 \002(\005\022\016\n\006height\030\003 \002(\005\022\021\n\tstr"
    "eam_id\030\004 \001(\005\022\022\n\ninput_name\030\005 \001(\t\022\021\n\ttime"
    "stamp\030\006 \002(\t", 131);
...
void image::SerializeWithCachedSizes(
  ...
  // optional int32 stream_id = 4;
  if (has_stream_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->stream_id(), output);
  }
...
::google::protobuf::uint8* image::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->image_data_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(1, this->image_data(i), target);
  }
  ...
  // optional int32 stream_id = 4;
  if (has_stream_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->stream_id(), target);
  }
